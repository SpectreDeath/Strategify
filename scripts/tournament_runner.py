...
def run_tournament(num_simulations: int = 5, steps_per_sim: int = 10):
    ...
    results = {"Nash": {"tension": [], "escalations": []}, "Cognitive": {"tension": [], "escalations": []}}
    ...
    for i in range(num_simulations):
        model = GeopolModel(
            region_gdf=minimal_gdf, enable_governance=True, enable_economics=False, enable_temporal=False
        )
